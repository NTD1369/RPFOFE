...
import { Sale, Service } from 'src/app/_services/test/app.service';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-shop-item-serial',
  templateUrl: './shop-item-serial.component.html',
  styleUrls: ['./shop-item-serial.component.css']
})
export class ShopItemSerialComponent implements OnInit {
  ...
  constructor(  private itemService: ItemService, private alertify: AlertifyService, private mwiService: MwiService, private routeNav: Router, private itemserialService: ItemserialService,
           private basketService: BasketService , public modalRef: BsModalRef , private route: ActivatedRoute, public authService: AuthService,
            ) { 
