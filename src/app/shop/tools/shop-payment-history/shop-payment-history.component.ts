...
@Component({
  selector: 'app-shop-payment-history',
  templateUrl: './shop-payment-history.component.html',
  styleUrls: ['./shop-payment-history.component.css']
})
export class ShopPaymentHistoryComponent implements OnInit {
  ...
  toggleVoucherList()
  {
    ...
    { 
      this.payments.forEach(val => newArray.push(Object.assign({}, val))); 
      this.paymentsTemp = newArray;
      this.payments = this.voucherList; 
    }
    else
    { 
  ...
  ngOnInit() {
    ...
    this.voucherList = this.payments.filter(x=>x.paymentType === 'V');
    var newArray = []; 
    this.voucherList.forEach(val => newArray.push(Object.assign({}, val))); 
    this.payments = this.payments.filter(x=>x.paymentType !== 'V');
