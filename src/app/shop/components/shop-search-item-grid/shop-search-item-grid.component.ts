...
@Component({
  selector: 'app-shop-search-item-grid',
  templateUrl: './shop-search-item-grid.component.html',
  styleUrls: ['./shop-search-item-grid.component.scss']
})
export class ShopSearchItemGridComponent implements OnInit {
