...
@Component({
  selector: 'app-management-import-userstore',
  templateUrl: './management-import-userstore.component.html',
  styleUrls: ['./management-import-userstore.component.scss']
})
export class ManagementImportUserstoreComponent implements OnInit {

 
  value: any[] = [];
  importContent: MUserStore[] = [];
  isResult= false;
  constructor(private commonService: CommonService ,private userstoreService: UserstoreService, private excelSrv: ExcelService, private alertifyService: AlertifyService, private route: ActivatedRoute, private router: Router) { }
  downloadTemplate()
  {
  ...
  onFileChange(evt: any) {
    ...
    reader.onload = (e: any) => {
      ...
      const header: string[] = Object.getOwnPropertyNames(new MUserStore());
  ...
  onImportData()
  {
    ...
    data.userStore  = this.importContent;
    
    this.userstoreService.import(data).subscribe((response: any)=>{
