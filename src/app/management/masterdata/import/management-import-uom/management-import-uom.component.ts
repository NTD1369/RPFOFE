...
@Component({
  selector: 'app-management-import-uom',
  templateUrl: './management-import-uom.component.html',
  styleUrls: ['./management-import-uom.component.scss']
})
export class ManagementImportUomComponent implements OnInit {

  value: any[] = [];
  importContent: MUom[] = [];
  isResult= false;
  constructor(private commonService: CommonService ,private uomService: UomService, private authService : AuthService, private excelSrv: ExcelService, private alertifyService: AlertifyService, private route: ActivatedRoute, private router: Router) { }
  downloadTemplate()
  {
    this.commonService.download('M_UOM.xlsx');
  }
  ...
  onFileChange(evt: any) {
    ...
    reader.onload = (e: any) => {
      ...
      const header: string[] = Object.getOwnPropertyNames(new MUom());
  ...
  onImportData()
  {
    ...
    this.uomService.import(data).subscribe((response: any)=>{
