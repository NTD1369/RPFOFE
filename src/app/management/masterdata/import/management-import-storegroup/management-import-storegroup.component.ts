...
@Component({
  selector: 'app-management-import-storegroup',
  templateUrl: './management-import-storegroup.component.html',
  styleUrls: ['./management-import-storegroup.component.scss']
})
export class ManagementImportStoregroupComponent implements OnInit {


  value: any[] = [];
  importContent: MStoreGroup[] = [];
  isResult= false;
  constructor(private commonService: CommonService ,private storegroupService: StoregroupService, private excelSrv: ExcelService, private alertifyService: AlertifyService, private route: ActivatedRoute, private router: Router) { }
  downloadTemplate()
  {
    this.commonService.download('M_StoreGroup.xlsx');
  }
  ...
  onFileChange(evt: any) {
    ...
    reader.onload = (e: any) => {
      ...
      const header: string[] = Object.getOwnPropertyNames(new MStoreGroup());
  ...
  onImportData()
  {
    ...
    data.storeGroup  = this.importContent;
    
    this.storegroupService.import(data).subscribe((response: any)=>{
