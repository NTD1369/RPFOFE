...
@Component({
  selector: 'app-management-saleschannel-edit',
  templateUrl: './management-saleschannel-edit.component.html',
  styleUrls: ['./management-saleschannel-edit.component.scss']
})
export class ManagementSaleschannelEditComponent implements OnInit {

  
  @Input() model: MSalesPlanHeader; 
  ...
  constructor(  private controlService: ControlService,  
     public authService: AuthService,  private alertifyService: AlertifyService, 
