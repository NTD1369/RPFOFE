...
@Component({
  selector: 'app-management-holiday-edit',
  templateUrl: './management-holiday-edit.component.html',
  styleUrls: ['./management-holiday-edit.component.scss']
})
export class ManagementHolidayEditComponent implements OnInit {

  @Input() model: MHoliday; 
  @Input() isNew: false; 
