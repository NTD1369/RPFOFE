...
@Component({
  selector: 'app-management-masterdata-uom-edit',
  templateUrl: './management-masterdata-uom-edit.component.html',
  styleUrls: ['./management-masterdata-uom-edit.component.scss']
})
export class ManagementMasterdataUomEditComponent implements OnInit {
  ...
  controlList: any[];
  groupControlList: {};
  constructor(private uomService: UomService, private authService: AuthService,
