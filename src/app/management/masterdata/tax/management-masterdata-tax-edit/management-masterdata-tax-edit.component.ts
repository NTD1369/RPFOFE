...
@Component({
  selector: 'app-management-masterdata-tax-edit',
  templateUrl: './management-masterdata-tax-edit.component.html',
  styleUrls: ['./management-masterdata-tax-edit.component.scss']
})
export class ManagementMasterdataTaxEditComponent implements OnInit {
