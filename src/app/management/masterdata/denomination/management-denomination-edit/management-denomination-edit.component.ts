...
@Component({
  selector: 'app-management-denomination-edit',
  templateUrl: './management-denomination-edit.component.html',
  styleUrls: ['./management-denomination-edit.component.scss']
})
export class ManagementDenominationEditComponent implements OnInit {
  ...
  controlList: any[];
  groupControlList: {};
  constructor( private controlService: ControlService, private commonService: CommonService,
