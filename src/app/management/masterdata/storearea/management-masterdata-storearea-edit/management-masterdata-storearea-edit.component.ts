...
@Component({
  selector: 'app-management-masterdata-storearea-edit',
  templateUrl: './management-masterdata-storearea-edit.component.html',
  styleUrls: ['./management-masterdata-storearea-edit.component.scss']
})
export class ManagementMasterdataStoreareaEditComponent implements OnInit {


  @Input() model: MStoreArea;
