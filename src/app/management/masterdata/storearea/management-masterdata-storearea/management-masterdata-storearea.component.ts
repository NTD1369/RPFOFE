...
@Component({
  selector: 'app-management-masterdata-storearea',
  templateUrl: './management-masterdata-storearea.component.html',
  styleUrls: ['./management-masterdata-storearea.component.scss']
})
export class ManagementMasterdataStoreareaComponent implements OnInit {


  functionId = "Adm_StoreArea";
  items: MStoreArea[];
  ...
  constructor(private storeareaService: StoreareaService, private alertify: AlertifyService, private router: Router, private authService: AuthService,
  ...
  updateModel(model) {
    ...
    if (this.isNew) {
      ...
      this.storeareaService.create(model).subscribe((response: any) => {
        if (response.success) {
      ...
      this.storeareaService.update(model).subscribe((response: any) => {
        if (response.success) {
