...
@Component({
  selector: 'app-management-masterdata-itemgroup-edit',
  templateUrl: './management-masterdata-itemgroup-edit.component.html',
  styleUrls: ['./management-masterdata-itemgroup-edit.component.scss']
})
export class ManagementMasterdataItemgroupEditComponent implements OnInit {


  @Input() model: MItemGroup;
