...
@Component({
  selector: 'app-rpt-sync-price',
  templateUrl: './rpt-sync-price.component.html',
  styleUrls: ['./rpt-sync-price.component.scss']
})
export class RptSyncPriceComponent implements OnInit {
  ...
  loadItems(companycode,  from, to, FItem, TItem) {
    ...
    this.reportService.Get_RPT_SYNC_PRICE_CMP(companycode, FItem, TItem, fromvl, tovl).subscribe((res:any) => {
      // loadItems
      // debugger;
