...
@Component({
  selector: 'app-pdf_rpt_salestransactiondetail',
  templateUrl: './pdf_rpt_salestransactiondetail.component.html',
  styleUrls: ['./pdf_rpt_salestransactiondetail.component.scss']
})
export class Pdf_rpt_salestransactiondetailComponent implements OnInit {
