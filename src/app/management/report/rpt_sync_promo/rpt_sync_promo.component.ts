...
@Component({
  selector: 'app-rpt_sync_promo',
  templateUrl: './rpt_sync_promo.component.html',
  styleUrls: ['./rpt_sync_promo.component.scss']
})
export class Rpt_sync_promoComponent implements OnInit {
  ...
  loadItems(companycode,  from, to, FItem, TItem) {
    ...
    this.reportService.Get_RPT_SYNC_PROMO_CMP(companycode, FItem, TItem, fromvl, tovl).subscribe((res:any) => {
      // loadItems
      // debugger;
