...
@Component({
  selector: 'app-rpt_SalesEPAYDetail',
  templateUrl: './rpt_SalesEPAYDetail.component.html',
  styleUrls: ['./rpt_SalesEPAYDetail.component.scss']
})
export class Rpt_SalesEPAYDetailComponent implements OnInit {
  ...
  constructor(private reportService: ReportService, private alertify: AlertifyService, private router: Router,public authService: AuthService,
    private controlService: ControlService, private modalService: BsModalService, public datepipe: DatePipe, private route: ActivatedRoute, private storeService: StoreService) {
  ...
  controlList: any[];
  functionId = "RPT_SalesEPAYDetail";
  ...
  loadItems(companycode, store, user, from, to) {
    ...
    this.reportService.Get_RPT_SalesEPAYDetail(companycode, store, user, fromvl, tovl).subscribe((res:any) => {
      // loadItems
      // debugger;
