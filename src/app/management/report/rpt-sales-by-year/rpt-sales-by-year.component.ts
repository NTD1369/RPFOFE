...
@Component({
  selector: 'app-rpt-sales-by-year',
  templateUrl: './rpt-sales-by-year.component.html',
  styleUrls: ['./rpt-sales-by-year.component.scss']
})
export class RptSalesByYearComponent implements OnInit {
  ...
  loadItems(companycode, store, user, from, to) {
    ...
    this.reportService.Get_RPT_SalesByYear(companycode, '', user, fromvl, tovl).subscribe((res:any) => {
      // loadItems
