...
@Component({
  selector: 'app-rpt_salestransactiondetail_ex',
  templateUrl: './rpt_salestransactiondetail_ex.component.html',
  styleUrls: ['./rpt_salestransactiondetail_ex.component.scss']
})
export class Rpt_salestransactiondetail_exComponent implements OnInit {
  ...
  isNew:boolean = false;
  storeOptions:any =[];
  title = "Sales Transaction Detail (Exchange)";
  @ViewChild(DxDataGridComponent, { static: false }) dataGrid: DxDataGridComponent;
 
  constructor(private reportService: ReportService, private alertify: AlertifyService, private router: Router, public authService: AuthService, public commonService: CommonService,  
  ...
  onToolbarPreparing(e) {
    ...
    onExporting(e) {
      ...
      let nameOfRpt= 'SalesTransactionDetailExchange' ;
      var d = new Date();
    ...
    controlList: any[];
    functionId = "RPT_SalesTransactionDetail_Ex";
  ...
  loadItems(companycode, store, user, from, to) {
    ...
    this.rpTitle += " Report";
    this.reportService.get_RPT_SalesTransactionDetail_Ex(companycode, store, user, fromvl, tovl).subscribe((res:any) => {
      // loadItems
      // debugger;
