...
@Component({
  selector: 'app-rpt-POS-promo',
  templateUrl: './rpt-POS-promo.component.html',
  styleUrls: ['./rpt-POS-promo.component.scss']
})
export class RptPOSPromoComponent implements OnInit {
  ...
  loadItems(companycode, store, user, from, to) {
    ...
    this.reportService.Get_RPT_POSPromo( fromvl, tovl, this.authService.storeSelected().storeId ).subscribe((res:any) => {
