...
@Component({
  selector: 'app-rpt_SyncDataStatusByIdoc',
  templateUrl: './rpt_SyncDataStatusByIdoc.component.html',
  styleUrls: ['./rpt_SyncDataStatusByIdoc.component.scss']
})
export class Rpt_SyncDataStatusByIdocComponent implements OnInit {


  dataTypes= [
    {value: 'MasterData', name: 'Master Data'},
    {value: 'SellingPrice', name: 'Selling Price'},
  ...
  controlList: any[];
  functionId = "rpt_SyncDataStatusByIdoc";
  ...
  viewReport(IdocNum, DataType)
  {
    debugger;
    // this.authService.storeSelected().storeId
    this.loadItems(this.authService.storeSelected().companyCode,   IdocNum , DataType);
  }
  loadItems(companycode,   IdocNum, DataType) {
    debugger;
     
    if(IdocNum===null || IdocNum===undefined)
    {
      IdocNum='';
    }
    ...
    this.reportService.Get_RPT_SyncDataStatusByIdoc(companycode, IdocNum, DataType).subscribe((res:any) => {
      // loadItems
      // debugger;
