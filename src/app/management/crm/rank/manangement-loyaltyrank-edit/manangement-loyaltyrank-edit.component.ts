...
@Component({
  selector: 'app-manangement-loyaltyrank-edit',
  templateUrl: './manangement-loyaltyrank-edit.component.html',
  styleUrls: ['./manangement-loyaltyrank-edit.component.css']
})
export class ManangementLoyaltyrankEditComponent implements OnInit {


  @Input() model: SLoyaltyRank; 
  @Input() isNew: false; 
  ...
  controlList: any[];
  groupControlList: {};
  constructor(private rankService: LoyaltyrankService, private controlService: ControlService, 
