...
@Component({
  selector: 'app-management-barcode-setup-detail',
  templateUrl: './management-barcode-setup-detail.component.html',
  styleUrls: ['./management-barcode-setup-detail.component.scss']
})
export class ManagementBarcodeSetupDetailComponent implements OnInit {

 
  @Input() model: SBarcodeSetup;
  ...
  update() {
    ...
    // this.model.Crea = this.authService.decodeToken?.unique_name;
