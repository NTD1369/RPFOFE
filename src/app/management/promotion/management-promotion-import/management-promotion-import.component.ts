...
@Component({
  selector: 'app-management-promotion-import',
  templateUrl: './management-promotion-import.component.html',
  styleUrls: ['./management-promotion-import.component.scss']
})
export class ManagementPromotionImportComponent implements OnInit {

  value: any[] = [];
  importContent: PromotionViewModel[] = [];
  isResult= false;
  constructor(private commonService: CommonService ,private promotionService: PromotionService, private excelSrv: ExcelService, private alertifyService: AlertifyService,
