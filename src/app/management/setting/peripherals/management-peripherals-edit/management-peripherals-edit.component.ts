...
@Component({
  selector: 'app-management-peripherals-edit',
  templateUrl: './management-peripherals-edit.component.html',
  styleUrls: ['./management-peripherals-edit.component.scss']
})
export class ManagementPeripheralsEditComponent implements OnInit {


  @Input() model: MPeripherals;
