...
import { SSalesPlan } from 'src/app/_models/salesplan';
...
@Component({
  selector: 'app-management-sales-plan-edit',
  templateUrl: './management-sales-plan-edit.component.html',
  styleUrls: ['./management-sales-plan-edit.component.scss']
})
export class ManagementSalesPlanEditComponent implements OnInit {

 
  @Input() model: SSalesPlan;
