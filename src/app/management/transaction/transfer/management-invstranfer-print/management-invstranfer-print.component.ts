...
@Component({
  selector: 'app-management-invstranfer-print',
  templateUrl: './management-invstranfer-print.component.html',
  styleUrls: ['./management-invstranfer-print.component.scss']
})
export class ManagementInvtranfePrintComponent implements OnInit {
