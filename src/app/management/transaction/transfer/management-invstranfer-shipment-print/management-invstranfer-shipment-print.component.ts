...
@Component({
  selector: 'app-management-invstranfer-shipment-print',
  templateUrl: './management-invstranfer-shipment-print.component.html',
  styleUrls: ['./management-invstranfer-shipment-print.component.scss']
})
export class ManagementInvtranfeShipmentPrintComponent implements OnInit {
